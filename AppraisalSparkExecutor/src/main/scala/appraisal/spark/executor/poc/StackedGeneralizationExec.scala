...
import appraisal.spark.algorithm.StackedGeneralization

object StackedGeneralizationExec {
  def main(args: Array[String]) {
    ...
    try {
      ...
      val imputationResult = new StackedGeneralization().run(_vnidf, _vnodf, params)
